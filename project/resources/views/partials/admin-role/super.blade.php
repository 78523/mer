...
<li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-sb-index') }}"><span>{{ __('Banners') }}</span></a>
            </li>

            <li>
                <a href="{{ route('admin-sb-large') }}"><span>{{ __('Bottom Banner') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-ps-page-banner') }}"><span>{{ __('Large Banner') }}</span></a>
            </li>
            <li>
