      ...
      <div class="container-fluid">
          <div class="row align-items-center">
              <div class="col-lg-4 sm-mx-none">
                  <a href="help-center.html" class="text-general"><span>{{__('Contact & Support')}} : {{$ps->phone}}</span></a>
              </div>
        ...
        <div class="row align-items-center">
            <div class="col-xxl-2 col-xl-2 col-lg-3 col-6 order-lg-1">
                <div class="d-flex align-items-center h-100 md-py-10">
                    ...
                    <a class="navbar-brand" href="index.html"><img class="nav-logo" src="{{asset('assets/images/'.$gs->logo)}}" alt="Image not found !"></a>
                </div>
            </div>
